CLASS zcl_generate_travel_data_825 DEFINITION
...
CLASS zcl_generate_travel_data_825 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_825.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_825.

*   insert the new table entries
    INSERT ztravel_825 FROM TABLE @itab.
