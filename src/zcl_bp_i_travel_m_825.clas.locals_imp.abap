...
CLASS lhc_travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  ...
  PRIVATE SECTION.
    ...
    TYPES tt_travel_update TYPE TABLE FOR UPDATE zi_travel_m_825.
...
**********************************************************************
  METHOD validate_customer.
    ...
    READ ENTITY zi_travel_m_825\\travel FROM VALUE #(
...
********************************************************************************
  METHOD set_status_completed.
    ...
    MODIFY ENTITIES OF zi_travel_m_825 IN LOCAL MODE
           ENTITY travel
    ...
    READ ENTITIES OF zi_travel_m_825 IN LOCAL MODE
         ENTITY travel
...
********************************************************************************
  METHOD get_features.
    ...
    READ ENTITY zi_travel_m_825 FROM VALUE #( FOR keyval IN keys
                                                      (  %key                    = keyval-%key
  ...
  METHOD calculatetravelkey.
    ...
    "Get max travelID
    SELECT SINGLE FROM ztravel_825 FIELDS MAX( travel_id ) INTO @DATA(lv_max_travelid).
